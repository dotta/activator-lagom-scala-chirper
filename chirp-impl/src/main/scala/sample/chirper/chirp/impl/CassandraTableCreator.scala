...
class CassandraTableCreator @Inject() (db: CassandraSession, system: ActorSystem, config: CassandraTableCreator.Config)(implicit ec: ExecutionContext) {
  private val log = LoggerFactory.getLogger(classOf[CassandraTableCreator])
